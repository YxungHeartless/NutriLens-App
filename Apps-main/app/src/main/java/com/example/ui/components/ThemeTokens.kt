...
val CarbYellow = Color(0xFFF59E0B)   // Visual indicator for carbs
val FatBlue = Color(0xFF3B82F6)      // Visual indicator for fats
val ProteinOrange = Color(0xFFED64A6) // Visual indicator for protein
